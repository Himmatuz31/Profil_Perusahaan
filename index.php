...
//fungsi fitur kirim email
        ...
        // More headers
        $headers .= 'From: <info@culinaryindonesianfood.com>' . "\r\n";
        $headers .= 'Cc: culinaryindonesianfood.com' . "\r\n";
            ...
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="navbar-header">
                    <button type="button" id="nav-toggle" class="navbar-toggle" data-toggle="collapse" data-target="#main-nav">
                     ...
                     <p class="language"><?=language?>  <a href="index.php?lang=in"> Indonesia </a>  <a href="index.php?lang=en"> </a></p>
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-12">
                    <div class="connect-us">
                        ...
                        echo "
                        <ul>                            
                        <li><a href=\"https://web.facebook.com/Culinaryindonesianfood-100202379131777/$showcontactus[id_facebook]\" target=\"_blank\"><i class=\"fa fa-facebook\"></i></a></li>
                        <li><a href=\"https://twitter.com/home/$showcontactus[id_twitter]\" target=\"_blank\"><i class=\"fa fa-twitter\"></i></a></li>
                        <li><a href=\"https://www.instagram.com/culinaryindonesianfood/$showcontactus[id_instagram]\" target=\"_blank\"><i class=\"fa fa-instagram\"></i></a></li>
                        <li><a href=\"https://www.youtube.com/channel/UCEREEGBYvDtg5h0tJwjllXw/$showcontactus[id_youtube]\" target=\"_blank\"><i class=\"fa fa-youtube\"></i></a></li>
                    </ul>";
                            }
                        ?>
                        <?php 
